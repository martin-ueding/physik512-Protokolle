...
Wir betrachten das Slow Signal des linken Photomultipliers auf dem Oszi
(Bildzeit 16:26), siehe Abbildung~\ref{fig:slow_signal}, links. Dann schauen
wir uns das Slow Signal des rechten PM auf dem Oszi an, siehe
...
\begin{figure}[htbp]
    ...
    \caption{%
        Slow-Signale vor dem Vorverstärker
    }
...
betrachten wir auf dem Oszi (Bildzeit links 15:03, rechts 16:41), siehe
...
Wir schließen den Ausgang des linken Hauptverstärkers an den Splitter an. Der eine
Ausgang geht an das SCA. Der Andere an Delay-Verstärker. Die Ausgänge beider
Geräte betrachten wir mit dem Oszilloskop. Nun versuchen wir, die Verzögerung so
