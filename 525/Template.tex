...
\begin{figure}[htbp]
    \centering
    Diese Abbildung ist in deinem Repo leider nicht verfügbar. Dies tut uns
    leid :-/
    %\includegraphics[width=.5\textwidth]{../Abbildungen/WW-Demtroeder.pdf}
    \caption{%
        Dominierende Wechselwirkung zwischen $\gammaup$-Strahlung und Materie in
        Abhängigkeit von Photonenergie $E_\gammaup$ und Ordnungszahl
...
%TODO: Rückstreupeak, Single-/ Double-Escape-Peak hier oder bei Szintillator
...
%TODO Subsections mit Einteilung des Versuchs
...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot[black] table {../Daten/Zeiteichung.txt};
            \addplot[red, very thick] table {fit_prompt_0.txt};
...
exponentielle Zerfallskurve mit Lebensdauer $\tau$ an. Die Anpassung gibt uns
