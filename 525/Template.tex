...
sind in Abbildung~\ref{fig:fit:energieeichung} dargestellt.
...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}
        \begin{axis}[width=0.45\linewidth, height=0.3\linewidth, xlabel=Kanal,
            ...
            \addplot[black, only marks, mark=+] table {fit_detektor_links_data.txt};
    ...
    \begin{tikzpicture}
        \begin{axis}[width=0.45\linewidth, height=0.3\linewidth, xlabel=Kanal,
            ylabel={Energie / \si{\kilo\electronvolt}}]
            \addplot[black, only marks, mark=+] table {fit_detektor_rechts_data.txt};
...
\begin{figure}[htbp]
    \begin{tikzpicture}
        \begin{axis}[width=\linewidth, height=0.3\linewidth, xlabel=Kanal,
            ...
            \addplot[black, only marks, mark=+] table {fit_detektor_prompt_data.txt};
...
Wir haben die Lebenszeit des Übergangs auf \SI{<< tau >>}{\nano\second}
bestimmen können.
