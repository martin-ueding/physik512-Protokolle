...
sehen. Es zerfällt durch Elektroneneinfang zu ${}^{133}$Cs. Zu
...
verstärken. Diese Verstärkung ist nur für einen begrenzten
Eingangs-Amplituden-Bereich und einen Verstärkungsbereich linear. Da bei
vielen Anwendungen Linearität gewährleistet sein muss, werden meist Vor- und
Hauptverstärker verwendet.
...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{Spektrum der Na-Probe im linken und rechten Detektor}
    \label{mca:001_004}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \end{tikzpicture}
    \caption{%
        Spektrum der Na-Probe im linken und rechten Detektor mit höherer
...
\begin{figure}[htbp]
    ...
    \caption{%
        Koinzidenzeinheit und TAC am Oszillator.
    }
    \label{fig:tac_oszi}
\end{figure}
...
das Delay und beide auf das Oszilloskop. Die Signale werden, wie in
Abschnitt~\ref{ssec:Trig_SCA} beschrieben, übereinander
...
Dann wird ein Spektrum, wie in Abschnitt~\ref{ssec:Spektrum_Na} beim Natrium,
mit dem MCA aufgenommen/* 009 */, siehe Abbildung~\ref{mca:ba_spek}.
...
\subsection{Anpassen an die Spektren}
...
\begin{figure}[htbp]
    ...
    \end{tikzpicture}
    \caption{%
        Anpassungskurven an die Spektren der Na-Probe im linken und rechten
        Detektor.
    }
    \label{fig:fit:na}
\end{figure}
...
Für den linken Detektor finden wir folgende
Anpassungsgerade\footnote{\erklaerungFehlerNotation}:
\[
...
Damit können wir die Standardabweichung der Linien in ein Energieinterval
...
\begin{figure}[htbp]
    \centering
    \begin{tikzpicture}
        \begin{axis}[width=\linewidth, height=0.4\linewidth, xlabel=Kanal,
