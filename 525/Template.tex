...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}
        \begin{axis}[width=0.45\linewidth, height=0.3\linewidth, xlabel=Kanal, ylabel=Ereignisse, axis lines=left]
            \addplot[black] table {../Daten/010-Ba-SCA-r.txt};
        \end{axis}
    \end{tikzpicture}
    \caption{%
...
Beispiel für den Fast-Abgleich (Bildzeit 13:54).

Wir setzen die obere Schwelle für den rechten SCA herab und überprüfen das
Spektrum erneut (014).
