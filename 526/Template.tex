...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot[red] table {plot-decay-fit-00mm.txt};
            \addplot[red] table {plot-decay-fit-01mm.txt};
            \addplot[red] table {plot-decay-fit-05mm.txt};
            \addplot[red] table {plot-decay-fit-10mm.txt};
            \addplot[red] table {plot-decay-fit-20mm.txt};
            \addplot[red] table {plot-decay-fit-50mm.txt};
...
Da $a = \SI{<< alu_a >>}{\per\milli\meter} = n \sigma$ ist, erhalten wir
...
\begin{figure}[htbp]
    ...
    \end{tikzpicture}
    \caption{%
        Energiespektrum von ${}^{133}$Ba. Zu erkennen ist die
