...
\begin{figure}[htbp]
    ...
    \caption{%
        ...
        jedoch sind jedoch extrem klein.
    }
    \label{fig:decay}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot[blue] table[skip first n=117] {../Daten/01_Untergrund001.txt};
            \addplot[black] table {../_build/fit_peak_662.txt};
        \end{axis}
    \end{tikzpicture}
    \caption{%
...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot[blue] table[skip first n=83] {../Daten/Spektrum_Ba001.txt};
            \addplot[black] table {../_build/fit_peak_31.txt};
            \addplot[black] table {../_build/fit_peak_81.txt};
            \addplot[black] table {../_build/fit_peak_356.txt};
        \end{axis}
    \end{tikzpicture}
    \caption{%
