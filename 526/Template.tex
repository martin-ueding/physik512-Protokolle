...
Alle Spektren zusammen sind in Abbildung~\ref{fig:spektrum_alle_roh} gezeigt.
...
\begin{figure}[htbp]
    ...
    \end{tikzpicture}
    \caption{%
        Spektrum des Plastik und Untergrund für alle Winkel zusammen. Die
