...
\]
an, deren Integral einfach nur $a$ ist. 
...
\begin{figure}[htbp]
    ...
    \caption{%
        ...
        Anpassungen der vorherigen Abbildung.
    }
    \label{fig:}
\end{figure}

Wir haben zusätzlich die Spektren mit einen Gaußkern gefaltet ($\sigma =
\num{<< extinction_gauss_sigma >>}$), um diese zu glätten. Danach haben wir die
Spektren durch das ohne Absorber geteilt, um ein Auslöschungsverhältnis zu
erhalten. Diese normalisierten Spektren haben wir in
Graph~\ref{fig:extinktion} dargestellt.
