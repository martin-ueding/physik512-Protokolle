...
\begin{figure}[htpb]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot[color=black] table {../Daten/01-Cs-40s_bearb.txt};
        \end{axis}
    \end{tikzpicture}
    \caption{%
...
\begin{figure}[htpb]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot[color=black] table {../Daten/02-Cs-40s_bearb.txt};
        \end{axis}
    \end{tikzpicture}
    \caption{%
        $\betaup$-Spektrum von ${}^{137}$Cs bei \SI{40}{\second}
...
\begin{figure}[htpb]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot[color=black] table {../Daten/03-Cs-100s_bearb.txt};
        \end{axis}
    \end{tikzpicture}
    \caption{%
