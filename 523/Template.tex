...
epsilon_max_04_Tl_80s >>}$, was einer Energie von $E_\text{max} = \SI{<<
E_max_04_Tl_80s >>}{\kilo\electronvolt}$ entspricht.  Beim Natrium finden wir
$\epsilon_\text{max} = \num{<< epsilon_max_05_Na_200s >>}$, oder $E_\text{max}
= \SI{<< E_max_05_Na_200s >>}{\kilo\electronvolt}$. 
