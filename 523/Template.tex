...
\begin{figure}[htpb]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            table[x error index=2, y error index=3] {../Daten/01-Cs-40s_bearb.txt};
        \end{axis}
    \end{tikzpicture}
    \caption{%
...
\begin{figure}[htpb]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            table[x error index=2, y error index=3] {../Daten/02-Cs-40s_bearb.txt};
        \end{axis}
    \end{tikzpicture}
    \caption{%
        $\betaup$-Spektrum von ${}^{137}$Cs bei \SI{40}{\second}
...
\begin{figure}[htpb]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            table[x error index=2, y error index=3] {../Daten/03-Cs-100s_bearb.txt};
        \end{axis}
    \end{tikzpicture}
    \caption{%
...
\begin{figure}[htpb]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            table[x error index=2, y error index=3] {../Daten/04-Tl-80s_bearb.txt};
        \end{axis}
    \end{tikzpicture}
    \caption{%
...
%                y dir=both, y explicit
%            ]
%            table[x error index=2, y error index=3] {../Daten/05-Na-200s_bearb.txt};
%        \end{axis}
%    \end{tikzpicture}
    \caption{%
