...
da es sich hier um ein Zählexperiment handelt.\footnote\erklaerungFehlerNotation
...
\begin{figure}[htbp]
    ...
    \end{tikzpicture}
    \caption{%
    Versuchsaufbau für die Lebensdauerbestimmung von Myonen. Durchgezogene
    Linien bezeichnen analoge, gestrichelte bezeichnen digitale Signale
    }
