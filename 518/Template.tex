...
registriert werden, die von einem Myon stammen. Der \textsc{Stop}-Impuls kommt vom
zweiten Detektor, in dem das Myon zur Ruhe gekommen ist.

Da es theoretisch möglich ist, dass das Myon sofort zerfällt, sollte das
\textsc{Stop}-Signal etwas verzögert werden, damit das \textsc{Stop}-Signal nach dem
\textsc{Start}-Signal kommt. Die Lebensdauer bestimmt sich aus dem
...
\begin{quote}
    ...
    um ca. \SI{100}{\nano\second} verzögert. Warum ist das notwendig? Wie wirkt
    es sich auf das Messergebnis aus?
\end{quote}
...
Kommt es innerhalb der Messzeit in den \textsc{Start}- und \textsc{Stop}-Detektoren zu
